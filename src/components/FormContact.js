  ...
  return (
    <div className="md:w-2/5 md:px-1 px-6 py-10 w-full">
      <form onSubmit={handleSubmit}>
        ...
        <div class="relative z-0 mb-7 w-full group">
          <input type="email" name="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value={values.floating_email} onChange={handleChange} />
        ...
        <div class="relative z-0 mb-7 w-full group">
          <input type="text" name="floating_subject_msg" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value={values.floating_subject_msg} onChange={handleChange} />
        ...
        <div class="relative z-0 mb-4 w-full group">
          <textarea id="floating_msg" rows="4" name="floating_msg" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value={values.floating_msg} onChange={handleChange}></textarea>
